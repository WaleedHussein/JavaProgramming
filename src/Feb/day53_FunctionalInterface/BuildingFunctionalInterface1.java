...
public class BuildingFunctionalInterface1 {
...
//        }
        ...
        list2.forEach(p -> {if (p%2 !=0) System.out.println(p);}); // this works like the loop above

        System.out.println("+++++++++++++++++++++++++++");

        List<String> empoyees = new ArrayList<>();
        empoyees.addAll(Arrays.asList("Ali Ismayilov", "Waleed Hussein", "Nawar Hussein", "Hulia Something"));

        empoyees.forEach(p -> System.out.println(p.charAt(0) +"." + p.charAt(p.indexOf(" ") +1) ));
